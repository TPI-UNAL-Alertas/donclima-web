...
const Usuario = props => {
    ...
    return (
        <div className="background-form offset-md-5 mx-2 my-2 shadow-sm p-3 rounded">
            <form className="d-flex justify-content-center needs-validation " noValidate >
                <div className="forms">
                ...
                <button className="btn btn-warning btn-form mb-1" type="submit" onClick={updateUsuario}>Guardar</button>
            </form>
        </div>
    );
}
